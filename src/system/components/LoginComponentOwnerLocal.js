...
import { loginOwner } from '../../owners/reducers/owner'
...
export class LoginComponentOwnerLocal extends React.Component<void, Props, void> {
  static propTypes = {
